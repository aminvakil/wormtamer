...
- [Suppress reviews for equivalent rebases](suppress-equivalent-rebase-reviews.md): persist GitLab patch identities and skip repeated review generation and publication when only the merge request head changes.
