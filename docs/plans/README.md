...
2. [Learn from no-finding reviews](learn-from-no-finding-reviews.md): accept review-level feedback and derive repository-scoped advisory lessons when the latest published review has no findings.
